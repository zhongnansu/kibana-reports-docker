...
RUN curl https://artifacts.elastic.co/downloads/kibana/kibana-oss-7.10.0-linux-x86_64.tar.gz -o /opt/kibana-oss-7.10.0-linux-x86_64.tar.gz

RUN mkdir /usr/share/kibana
WORKDIR /usr/share/kibana

RUN tar --strip-components=1 -zxf /opt/kibana-oss-7.10.0-linux-x86_64.tar.gz
